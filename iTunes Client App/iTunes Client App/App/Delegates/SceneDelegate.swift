...
class SceneDelegate: UIResponder, UIWindowSceneDelegate {
    ...
    private func setupWindow(with windowScene: UIWindowScene) {
        ...
        viewController.title = "Podcast"
        viewController.tabBarItem.image = UIImage(systemName: "mic.fill")
        musicVC.title = "Music"
        musicVC.tabBarItem.image = UIImage(systemName: "music.note")
        movieVC.title = "Movie"
        movieVC.tabBarItem.image = UIImage(systemName: "tv")
       ...
       // navigationController.viewControllers.append(musicVC)
        let vcs = [navigationController , musicNav, movieNav, favNav]
      //  navigationController.navigationController?.pushViewController(musicVC, animated: true)
